...
public class AffichageEtude extends javax.swing.JPanel implements AfficherListePatientsListener{
    ...
    public void changerLangue(String langue){
        if (langue.equals("English")) {
            ...
            DateDemarrage.setText("Start date");
            DureeEtude.setText("Duration");
            PraticienHospitaliier.setText("Hospital practitioner");
            PatientsParticipants.setText("Patients participating in the study");
            BoutonAjouterUnPatientEtude.setText("Add a patient");
        }    
    }
